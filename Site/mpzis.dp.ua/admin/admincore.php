...
class AdminCore
{
	...
	function CreateNewCatForm()
	{
		...
		$out .= "<h2>Создание новой страницы сайта</h2><br>\n";
		
		$out .= "Укажите название ссылки на страницу (прим. 'index')<br>\n";
		
		$l = "document.getElementById(\"n_cat_temp\").value = this.value + \".tpl\";";
		$out .= "<input type=\"text\" id=\"n_cat_link\" onchange='$l' value=\"test\"/><br>\n";
		
		$out .= "Укажите название страницы (прим. 'Главная страница')<br>\n";
		$out .= "<input type=\"text\" id=\"n_cat_adm_title\" /><br>\n";
		
		$out .= "Укажите шаблон для страницы (прим. 'index.tpl')<br>\n";
		$out .= "<small> При указаниии неизвестного шаблона - он будет создан</small><br>\n";
...
*/
	...
	function inter_CreateTop( $result )
	{
		...
		$out .= "<a class='main2' href=$l>Список модулей</a>";
