...
/*--------------------- ¬ÕŒ—»“ »«Ã≈Õ≈Õ»ﬂ ¬ ¡ƒ(USERS) ƒÀﬂ  ŒÕ –“ÕŒ√Œ œŒÀ‹«Œ¬¿“≈Àﬂ -----------------------*/
...
/*----------------------------------------- PICTURES UPLOADER ------------------------------------------------*/
			$out .= "
				...
				<div id='picture'>
					<img src='' id='n_pic'>
					<br><a href='javascript: void(0)' onclick='chiliadmShowPicSelect();'>Set up</a>
				</div>
...
/*----------------------------------- END GET LODED PICTURES INTO LIST ------------------------------------------*/						
			$out .="
					...
					<div id='uploader'>
						...
						<form enctype='multipart/form-data' action='http://101ball.com/modules/mod_admin/admin/upload.php' method='post' id='uplForm'>
...
/*-------------------------- ¬€¬Œƒ»“ ‘Œ–Ã” ƒÀﬂ »«Ã≈Õ≈Õ»ﬂ ƒ¿ÕÕ€’ œŒÀ‹«Œ¬¿“≈Àﬂ -------------------------*/
...
/*----------------------------------------- PICTURES UPLOADER ------------------------------------------------*/
			$out .= "
				...
				<div id='picture'>
					...
					<br><a href='javascript: void(0)' onclick='chiliadmShowPicSelect();'>–ù–∞—Å—Ç—Ä–æ–∏—Ç—å</a>
				</div>
				<div id='picsSelector' style='display: none' >
					<div id='pics'>";
/*----------------------------------- GET LODED PICTURES INTO LIST ------------------------------------------*/	
